...
export default async function SocialImage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return new ImageResponse(
    <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%", height: "100%", padding: "70px 80px", background: "#faf9f6", color: "#242624", fontFamily: "sans-serif" }}>
