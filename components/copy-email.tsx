...
export function CopyEmail({ email, copyLabel, copiedLabel, errorLabel }: {
    email: string;
    copyLabel: string;
    copiedLabel: string;
    errorLabel: string;
    ...
    return <button type="button" className="copy-email" onClick={handleCopy} aria-label={label} title={label}>
